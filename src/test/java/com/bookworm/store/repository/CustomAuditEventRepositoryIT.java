package com.bookworm.store.repository;

import com.bookworm.store.BookwormLondonStoreApp;
import com.bookworm.store.config.Constants;
import com.bookworm.store.config.audit.AuditEventConverter;
import com.bookworm.store.domain.PersistentAuditEvent;
...
import static com.bookworm.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
